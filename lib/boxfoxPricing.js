...
export function calculateBoxPrice(params, customConfigs = null) {
  ...
  // Formula: ROUNDUP(designing + dieRatePerSheet + leafing)
  // Note: We use the rate here to match the user's breakdown (e.g. 100 + 0.25 -> 101)
  const AE2 = ru(design + (dieCutting ? dieRatePerSheet : 0) + leafing);
