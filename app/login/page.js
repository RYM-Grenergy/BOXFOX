...
import { ArrowRight, Mail, Lock, Box } from "lucide-react";
...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Success, redirect to home or lab
                    ...
                    <div className="bg-white/80 backdrop-blur-2xl p-10 sm:p-14 rounded-[2rem] sm:rounded-[3rem] border border-white/40 shadow-2xl shadow-gray-200/50">
                        ...
                        <div className="text-center mb-10">
                            ...
                            <p className="text-gray-500 font-medium text-sm tracking-wide uppercase">
                                ENTER YOUR CREDENTIALS TO ORDER YOUR CUSTOM BOXES
                            </p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center justify-between mt-2">
                                <label className="flex items-center gap-2 cursor-pointer group">
                                    <input type="checkbox" className="w-4 h-4 rounded-md border-gray-200 text-gray-950 focus:ring-gray-950" />
                                    <span className="text-xs font-bold text-gray-500 uppercase tracking-widest group-hover:text-gray-950 transition-colors">Remember Me</span>
                                </label>
                                <Link href="#" className="text-xs font-bold text-gray-950 uppercase tracking-widest hover:underline decoration-2 underline-offset-4">
                                    Forgot Password?
                                </Link>
                            </div>
                        ...
                        <div className="mt-10 text-center border-t border-gray-100 pt-8">
                            <p className="text-sm font-medium text-gray-500">
                                NEW TO BOXFOX?{" "}
                                <Link href="/signup" className="text-gray-950 font-black uppercase tracking-widest hover:underline decoration-2 underline-offset-4 ml-1">
                                    Create Account
                                </Link>
                            </p>
                        </div>
