...
export default function CategorySection() {
  return (
    <section id="categories" className="pt-12 pb-6 md:pt-16 md:pb-8 lg:pt-20 lg:pb-10 px-4 sm:px-6 md:px-12 bg-white text-gray-950 overflow-hidden selection:bg-emerald-500 selection:text-white" suppressHydrationWarning>
